...
namespace ProjectCalculator.Infrastructure.Factory.ContourPointsCalculator
{
    public class ContourPointCalculatorTypeD: ICoordinateCalculator
    {
        ...
        public ContourPointCalculatorTypeD(Shape shape, ParamFiz paramFiz)
        {
            _shape = shape;
        ...
        private void SetPoints()
        {
            ...
            _contourPoints.Add('D', Point.CreatePoint( _shape.B2 - _paramFiz.ZcFirstQuarter, _shape.H1 + _shape.H2 - _paramFiz.YcFirstQuarter));
            _contourPoints.Add('E', Point.CreatePoint( _shape.B2 - _paramFiz.ZcFirstQuarter, _shape.H1 - _paramFiz.YcFirstQuarter));
        }
    }
}
