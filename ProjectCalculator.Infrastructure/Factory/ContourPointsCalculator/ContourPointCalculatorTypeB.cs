...
namespace ProjectCalculator.Infrastructure.Factory.ContourPointsCalculator
{
    public class ContourPointCalculatorTypeB: ICoordinateCalculator
    {
        ...
        public ContourPointCalculatorTypeB(Shape shape, ParamFiz paramFiz)
        {
            _shape = shape;
        ...
        private void SetPoints()
        {
            ...
            _contourPoints.Add('B', Point.CreatePoint( _shape.B2 - _paramFiz.ZcFirstQuarter, -_paramFiz.YcFirstQuarter));
            ...
            _contourPoints.Add('E', Point.CreatePoint(_shape.B1 + _shape.B2 - _paramFiz.ZcFirstQuarter,_shape.H1 - _paramFiz.YcFirstQuarter));
        }
    }
}
