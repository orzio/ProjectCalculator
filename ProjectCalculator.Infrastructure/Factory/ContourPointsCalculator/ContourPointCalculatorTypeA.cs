...
{
    public class ContourPointCalculatorTypeA: ICoordinateCalculator
    {
        ...
        private void SetPoints()
        {
            ...
            _contourPoints.Add('E', Point.CreatePoint(_shape.B2 + _shape.B1 - _paramFiz.ZcFirstQuarter, _shape.H1 - _paramFiz.YcFirstQuarter));
        }
