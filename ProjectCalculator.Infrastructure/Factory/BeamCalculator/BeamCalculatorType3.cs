...
{
    public class BeamCalculatorType3:IBeamCalculator
    {
        private InternalForces _internalForces;
        private FixedSupport _fixedSupport;
        private Beam _beam;

        public BeamCalculatorType3(Beam beam)
        {
            _beam = beam;
        ...
        public IBeamCalculator CalculateMa()
        {
            ...
            _fixedSupport.M = _beam.P * (_beam.L1+_beam.L2+_beam.L3) + _beam.Q1 * _beam.L2 * (0.5 * _beam.L2 + _beam.L1) + _beam.Q2 * _beam.L3 * (0.5 * _beam.L3 + _beam.L1 + _beam.L2);
